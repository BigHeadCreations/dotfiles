...
export PATH="/opt/homebrew/Cellar/python@3.13/3.13.3/bin:$PATH"
export PATH="/opt/homebrew/Cellar/python@3.13/3.13.3/libexec/bin:$PATH" # this lets me use python3 as `python`
export LDFLAGS="-L/opt/homebrew/Cellar/python@3.13/3.13.3/lib"
export PKG_CONFIG_PATH="/opt/homebrew/Cellar/python@3.13/3.13.3/lib/pkgconfig"
